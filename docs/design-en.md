...
|---|---|---|---|
| text | deepseek | `deepseek-v4-pro` (low thinking; `llm.text.extract` can retarget extraction's model, grade and timeout alone - model currently empty, so extraction runs the reply model) | `TEXT_API_KEY` |
